<x-guest-layout>
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-black tracking-tight text-slate-900 dark:text-white">Selamat datang kembali</h1>
        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Masuk untuk melanjutkan ujian dan latihan TOEFL.</p>
    </div>
