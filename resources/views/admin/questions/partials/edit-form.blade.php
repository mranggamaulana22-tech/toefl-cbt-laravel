...
>
    @csrf
    @method('PUT')
    <input type="hidden" name="_row_no" value="{{ $rowNo }}">
    ...
    <div class="mt-4">
        <x-form-field
            ...
            :value="old('passage', $question->passage)"
            rows="4"
    ...
    <div class="mt-4">
        ...
        >
            @if($question->audio_path)
                <p class="text-xs mt-1 text-slate-500">File saat ini: {{ basename($question->audio_path) }}</p>
            @endif
        </x-form-field>
    </div>
    ...
    <div class="mt-4">
        <x-form-field
            ...
            :value="old('audio_transcript', $question->audio_transcript)"
            rows="4"
