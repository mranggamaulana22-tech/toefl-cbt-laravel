<x-app-layout>
    <div class="py-12 min-h-screen bg-gray-50 dark:bg-[#0b0d13]"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 animate-fade-in-down">
            ...
            <div class="p-4 mb-6 sm:rounded-xl border
                ...
                <form id="practice-history-filter-form" method="GET" action="{{ route('practice-history.index') }}" class="grid grid-cols-1 md:grid-cols-7 gap-3 items-end">
                ...
                <div class="mt-3 flex justify-end">
                    <a id="practice-history-export-link" href="{{ route('practice-history.export.csv') }}"
    ...
    <script>
        (function () {
            ...
            const form = document.getElementById('practice-history-filter-form');
            const searchInput = document.getElementById('search');
            const classSelect = document.getElementById('class');
            const angkatanSelect = document.getElementById('angkatan');
            const sortSelect = document.getElementById('sort');
            const resultsContainer = document.getElementById('practice-history-results');
            const exportLink = document.getElementById('practice-history-export-link');
            ...
            const updateExportLink = () => {
                ...
                exportLink.href = "{{ route('practice-history.export.csv') }}?" + params.toString();
            };
