...
<body class="bg-slate-200 py-8 font-sans-cert text-slate-900">

    {{-- Tombol Aksi (Tidak Ikut Terprint) --}}
    <div class="max-w-[297mm] mx-auto flex justify-between items-center mb-6 px-4 no-print">
        <div>
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('student.results.certificate.download', $result->id) }}" class="bg-emerald-600 text-white px-6 py-2.5 rounded-xl font-black hover:bg-emerald-700 shadow-md shadow-emerald-600/20 transition active:scale-95 inline-flex items-center">
    ...
    <div class="certificate-container bg-certificate shadow-2xl border border-slate-300 flex flex-col items-center justify-center p-12">
        
        {{-- Watermark Logo Transparan di Tengah --}}
        <div class="absolute inset-0 flex items-center justify-center opacity-[0.03] pointer-events-none">
            <img src="{{ asset('images/logo.webp') }}" class="w-[500px] h-[500px] object-contain" alt="Watermark" width="500" height="500" loading="lazy">
        </div>

        <div class="relative z-10 w-full flex flex-col items-center">
            
            {{-- Header: Logo & Title --}}
            <img src="{{ asset('images/logo.webp') }}" alt="Logo Piksi Ganesha" class="h-24 mb-4 object-contain" width="96" height="96" loading="lazy">
