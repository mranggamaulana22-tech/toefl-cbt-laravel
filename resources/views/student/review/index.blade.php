<x-app-layout>
    ...
    <div class="review-index-page min-h-screen text-white font-sans selection:bg-purple-500/30 overflow-hidden py-8 pt-4 md:pt-8 lg:pt-10" x-data="{ loaded: false }" x-init="$store.bg.enabled = true; loaded = true">
